...
- **Folder context menu** (right-click or the kebab button on a folder row): **New Folder**, **Move**, and **Edit** appear when you can edit the folder; **Archive** / **Unarchive** appears when you can delete it; **Permanently delete** appears on an archived folder when you can delete everything inside it; and **Permissions** appears when you can edit it.
- **Board card kebab menu**: **Edit** and **Permissions** appear when you can edit the board, and **Delete** appears when you can delete it. On an archived perpetual board the menu also offers **Permanently delete**, under the same rule.
