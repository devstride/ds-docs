...
The graph is built from the item's blocking relationships, so it is a natural companion to the [Relationships dialog](/getting-started/admin-onboarding-getting-started/item-workspace-tour/quick-links) where those relationships are created.
