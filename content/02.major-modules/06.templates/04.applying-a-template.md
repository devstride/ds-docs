...
Templates can specify a job role for work items and subtasks, including work waiting for a person. The preview checks the role and person together: a compatible chosen role is preserved, and a person without a chosen role uses their first eligible role. An explicitly incompatible pair is refused. Retired roles remain understandable on existing work, but cannot be selected for new template assignments.
