...
**Removing the person from your organization doesn't unlock it.** The records that share their address are still there, so the refusal stands afterwards just the same. If you have a genuine privacy request covering a current or former team member's address, contact support and we'll work through it with you — which is what the message on screen tells you to do.
