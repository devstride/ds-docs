...
#### Time
**User Time Tracking** – See the time an individual has logged, and against what.

**[Time Allocation Matrix](/major-modules/measure-performance-reports/what-is-the-time-allocation-matrix)** – Roll logged time up through your own item hierarchy and spread it across calendar months, to answer where the effort actually went. Built for capitalization reporting, client billing, and quarter-end allocation, and exportable to Excel.
