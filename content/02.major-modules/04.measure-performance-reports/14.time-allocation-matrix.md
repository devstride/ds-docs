...
For **Persona**, the workbook has a **Persona** column, monthly hours, **Total hours**, and **Allocation**. A **Monthly allocation** row under each persona shows its monthly percentage shares. Retired personas and **Unspecified** remain included, followed by **Grand total**. It uses the same completed report as the screen.
