...
<!-- TWIN COPY — keep in sync with content/01.getting-started/01.admin-onboarding-getting-started/16.api-keys/01.api-keys.md -->
...
| Old name | New name | Old names removed on |
|---|---|---|
| `lane` — `laneId` and other `lane*` keys, `/lanes…` paths, `*_lane` MCP tools | `status` | 2026-10-31 |
| `folder` — `folderNumber` and other `folder*` keys, `/folders…` paths, `*_folder` MCP tools, `folder-*` real-time events | `workstream` | 2026-10-01 |
