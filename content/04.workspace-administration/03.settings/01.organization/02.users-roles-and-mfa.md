...
Work and school Microsoft accounts are served by [Enterprise SSO](/workspace-administration/settings/organization/enterprise-sso) instead — the Microsoft button is for personal accounts.
...
The same rule applies to [Enterprise SSO](/workspace-administration/settings/organization/enterprise-sso): an organization that requires MFA can't use it either. If you want SSO, enforce multi-factor authentication at your identity provider instead.
::
