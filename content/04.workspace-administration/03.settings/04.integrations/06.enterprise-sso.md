...
| **Claimed Email Domains** | Your members' email domains, such as `acme.com`. The organization's domain may already be filled in. To add another, type the domain and press **Enter**. |
