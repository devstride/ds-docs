...
::alert{type="note" title="Use the portal's search bar, not its menus"}
Microsoft reorganizes the Entra admin center's navigation from time to time, so any menu path we print here goes stale. Searching for the screen by name is stable, and it's faster anyway.
::
...
**OIDC** — in the [Entra admin center](https://entra.microsoft.com), type **App registrations** into the search bar at the top of the page and open it, then select **New registration**. Microsoft's own walkthrough: [Register an application](https://learn.microsoft.com/entra/identity-platform/quickstart-register-app).
...
**SAML** — in the [Entra admin center](https://entra.microsoft.com), type **Enterprise applications** into the search bar at the top of the page and open it. Then **New application → Create your own application**, choose *Integrate any other application you don't find in the gallery*, and open **Single sign-on → SAML**. Microsoft's walkthrough: [Set up SSO for an application](https://learn.microsoft.com/entra/identity/enterprise-apps/add-application-portal-setup-sso).
