...
Create an application (app registration) in your identity provider, set that redirect URI on it, then collect three values to bring back to DevStride:
...
Create the SAML application in your identity provider, paste both values in, then export your provider's **metadata** — either a metadata URL or the metadata XML document — to bring back to DevStride.
