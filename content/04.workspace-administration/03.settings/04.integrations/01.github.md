...
You can attach a pull request that has already been merged, including one whose head branch GitHub deleted on merge — which many repositories do automatically. It keeps its original branch name in the Linked Branches list and still shows its checks.
::
