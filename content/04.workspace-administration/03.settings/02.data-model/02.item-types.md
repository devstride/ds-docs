---
title: "Item Types"
description: "How item types structure your hierarchy and what to do before changing an item's type."
...
When an item has children, the item-type control explains that their types may not be allowed under a different item type. To change the type through the app, first move those children elsewhere in the hierarchy. Archived children also count: move them, or delete them only if you no longer need them. Archiving children alone does not remove the restriction.

For a bulk item-type change, the selected items must share a parent type and have no children.
