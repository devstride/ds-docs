...
- **Time Tracking** is disabled (visible but not usable) for non-leaf items, or items whose time is rolled up from sub-items. For how time entries themselves work, see [Time Spent](/getting-started/admin-onboarding-getting-started/item-workspace-tour/right-bar-time-spent).
