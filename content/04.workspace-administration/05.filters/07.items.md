...
Once a list is filtered the way you want, an Admin can share it with chosen customer companies as a read-only list in the support portal — see [Shared Lists](/major-modules/workstreams-and-work-items/published-lists).
::
