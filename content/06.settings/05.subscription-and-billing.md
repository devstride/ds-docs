...
::alert{type="info" title="Admin and Owner only"}
The entire Organization Settings area — including Subscription & Billing — is available only to organization Owners and Admins. Members are automatically redirected to My Account and never see these pages. Subscriptions are managed per organization.
::
