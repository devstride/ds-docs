...
- **Enable Link Mode** — When enabled, item actions propagate down the dependency chain. See [Link Mode](/workstreams-and-work-items/link-mode) for how propagation works.
