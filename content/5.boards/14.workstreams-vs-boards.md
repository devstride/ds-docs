...
Structure these hierarchically using DevStride’s[ item types](/v1/docs/setting-up-your-item-type-hierarchy){target=`_blank`}. 
...
:::(Warning) (Avoid Structuring Workstreams by Team)
<br>
