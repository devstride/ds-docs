...
From [Plan Delivery](https://app.devstride.com/devstride/boards/f/9d794c9b-9655-4461-85c7-7baebf666004){target=`_blank`}, navigate to the perpetual or cycle board you wish to view and click Go.

See this [article](/v1/docs/14-creating-boards-and-using-cadences){target=`_blank`} for more on how to navigate to the board you wan to see.
...
In the example below, the review column has turned read because the rule set by the admin in [Settings - Statuses & WIP Limiters](https://app.devstride.com/devstride/organization/settings?section=lanes){target=`_blank`} has been exceeded.
