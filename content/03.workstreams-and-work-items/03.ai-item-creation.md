...
<!-- TWIN COPY — keep in sync with content/01.admin-onboarding-getting-started/09.using-ai-in-devstride/01.create-items-with-ai.md -->
...
::alert{type="tip" title="Combine a file with notes"}
You can attach a document *and* paste extra context in the same run — DevStride reads them together as one source. For a long or complex document, a clear structure (headings and lists) helps the AI pick out the distinct items.
::
