...
For spreadsheet-style **weekly** time entry in the **Weekly Logs** plugin (under **Plugins** in the app menu), see the [Weekly Logs Plugin](/weekly-logs-plugin/overview) section.