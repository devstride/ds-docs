...
description: "The .claude/ds-config.json settings read or written by DevStride for Claude Code v3.1.1."
---

# Configuration Reference: `.claude/ds-config.json`

This page describes the repository contract for plugin **v3.1.1**. The file lives in the consuming repository, and its values override the plugin’s inline fallbacks.
...
When setup detects Codex and you confirm it, it offers this context-first pair:
