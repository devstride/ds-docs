...
description: "The .claude/ds-config.json settings read or written by DevStride for Claude Code v3.4.0."
---

# Configuration Reference: `.claude/ds-config.json`

This page describes the repository contract for plugin **v3.4.0**. The file lives in the consuming repository, and its values override the plugin’s inline fallbacks.
