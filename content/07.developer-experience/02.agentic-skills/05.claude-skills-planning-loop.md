...
Run `/clear` before switching from planning to execution: the session gate keeps authoring and execution commands in separate sessions. See [The Delivery Loop](/developer-experience/agentic-skills/claude-skills-delivery-loop) before handing the plan to `/loop`.
