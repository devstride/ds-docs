...
Version **3.5.1** ships **twenty skills**. The source and release history live in [`devstride/claude-plugin`](https://github.com/devstride/claude-plugin).
...
3. Run `/devstride:doctor` to find missing tools, authentication, or CI wiring — it repairs what is safe to repair and hands you the exact command for the rest.
...
Afterwards, `/devstride:doctor` is the one command to re-run regularly — it checks the repository prerequisites and reports any required repairs. To stop updating the plugin by hand, [turn on marketplace auto-update](/developer-experience/agentic-skills/getting-the-skills#staying-in-sync); it is off by default for third-party marketplaces like this one.
::
...
| Local CLI reviewer rounds at a merge boundary | 1 | 1 | 2 — one review and one re-review of the fixes |
| Normal adversarial review cycles | 2 | 2 | 2 |
...
- [Skill Audit](/developer-experience/agentic-skills/skill-audit) — all twenty commands at a glance
