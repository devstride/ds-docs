...
Version **0.8.1** ships **seventeen skills**. The source and release history live in [`devstride/claude-plugin`](https://github.com/devstride/claude-plugin).
...
4. Plan under an existing DevStride container with `/devstride:plan I1234`.
...
- A **release unit** is the container whose completion produces a release pull request, usually an Epic.
- A **container** is any level above those, such as a Capability, Module, or Solution.
