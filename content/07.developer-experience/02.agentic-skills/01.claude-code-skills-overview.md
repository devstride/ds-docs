...
Version **3.3.0** ships **twenty skills**. The source and release history live in [`devstride/claude-plugin`](https://github.com/devstride/claude-plugin).
...
Afterwards, `/devstride:doctor` is the one command to re-run regularly — it costs nothing when all is well. To stop updating the plugin by hand, [turn on marketplace auto-update](/developer-experience/agentic-skills/getting-the-skills#staying-in-sync); it is off by default for third-party marketplaces like this one.
::
