...
Every skill in this system is prefixed `ds-` (short for "DevStride") and invoked as a slash command: `/ds-build-item`, `/ds-plan`, `/ds-pr`, and so on. The prefix signals "this skill knows DevStride's specific conventions" — branch naming, item lanes, the completion ritual — as opposed to a generic Claude Code skill.
::
