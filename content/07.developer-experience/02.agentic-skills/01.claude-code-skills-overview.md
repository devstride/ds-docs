...
| Local CLI reviewer rounds per item | 0 — Claude’s build-time pass is the local gate | 1 — findings are fixed, with no re-review | 2 — one review and one re-review of the fixes |
