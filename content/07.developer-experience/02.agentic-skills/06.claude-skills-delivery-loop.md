...
Empty arguments mean “next.” You can also name a leaf, say `next under I1234`, or pass a container number by itself to scope selection under that plan.

The next item is the highest-priority open leaf whose blockers are Done, inside the earliest-dated open container. Relationships are fetched explicitly because normal summary projections omit them.
