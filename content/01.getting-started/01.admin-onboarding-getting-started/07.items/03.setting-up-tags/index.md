---
title: "Admin Onboarding - Setting up Tags"
description: ""
---
...
::alert{type="info" title="When to Use Tags"}
...
::alert{type="warning" title="When NOT to use a tag"}
...
::alert{type="info" title="Using Tags vs. Fields"}
...
Next Up: [Statuses and WIP Limiters](/getting-started/admin-onboarding-getting-started/creating-and-using-statuses/setting-up-workflow-statuses)