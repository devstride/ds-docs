---
title: "Admin Onboarding - Populating and Managing Workstreams"
description: ""
---
...
Adding items one at a time is great for a few, but you don't have to. To turn notes or a document into a batch of items at once, see [Using AI in DevStride](/getting-started/admin-onboarding-getting-started/using-ai-in-devstride/create-items-with-ai). To build a whole workstream from a reusable spreadsheet, see [Import Templates](/getting-started/admin-onboarding-getting-started/populating-and-managing-workstreams/import-templates).
::
...
Next up: [The Item Workspace Tour](/getting-started/admin-onboarding-getting-started/item-workspace-tour/header)