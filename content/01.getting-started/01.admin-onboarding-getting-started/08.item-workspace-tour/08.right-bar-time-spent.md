...
The **Time Spent** field in the item's right bar shows the total time recorded against that item — its own logged time plus its descendants' — and it is editable on **every item, at every level of the hierarchy**:
