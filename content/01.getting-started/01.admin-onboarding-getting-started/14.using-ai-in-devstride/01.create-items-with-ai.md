...
<!-- TWIN COPY — keep in sync with content/02.major-modules/01.workstreams-and-work-items/03.ai-item-creation.md -->
...
- [The Item Workspace Tour](/getting-started/admin-onboarding-getting-started/item-workspace-tour/header) — work with an item once it exists
