...
| `/ds-insert-story` | `[parent-item] <free-text description>` | Both — directly runnable AND the canonical capture path `ds-story` step 6.5 invokes when a build turns up untracked work | Yes |
