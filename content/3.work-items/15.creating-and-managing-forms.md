...
**All custom fields and custom field types for the item type used for the form are available to be used in forms**. Custom field collections for each item type can be managed by visiting <a href="https://app.devstride.com/devstride/organization/settings?section=customFields" target="_blank" rel="noopener noreferrer">**Settings** > **Custom Fields**</a>. 
