...
:::(Info) (A Map You can Update with a Simple Drag and Drop)
...
:::
Next up: [The Item Workspace Tour](/v1/docs/05-admin-onboarding-item-workspace-tour){target=`_blank`}