...
DevStride uses a system called the [PERT](https://www.devstride.com/blog/pert-estimation-the-key-to-successful-project-planning-and-management){target=`_blank`} method for estimating time.
