...
Navigate to [Cadences](https://app.devstride.com/devstride/organization/settings?section=cadences){target=`_blank`} (1). Create a new cadence: Click New Planning Cadence (2).
