...
Upon clicking "Statuses & WIP Limiters," you'll be presented with the capability to edit your board's statuses. It's important to note that certain statuses, such as "New" and "Done," are reserved by the system and cannot be altered. However, you have full freedom to create new statuses. This is done by clicking the green "New" button adjacent to the Create Status option. These statuses can be anything from "In-Progress" to "Review," depending on what best suits your team's workflow. Remember, you can always rename or change the color of these statuses at anytime to suit your needs. This is done by clicking the pencil icon next to the status name. If a status becomes unnecessary, it can be removed by selecting the red "X" icon.

**Grouping Statuses and Setting WIP Limiters**

A unique feature of this software is the ability to group statuses into collections. This not only helps in organizing tasks more logically but also allows you to set specific Work in Progress (WIP) Limiters for each status within a collection. WIP Limiters are crucial for controlling the flow of work, ensuring that not too much work is assigned within a cycle or to a particular team member, thus preventing bottlenecks. However, keep in mind that you cannot set WIP Limiters for the "New" or "Done" statuses. To create a collection, simply drag the statuses from the right side under "Create Status" to your desired collection spot. This feature is particularly beneficial for organizations with multiple teams, as it allows for the creation of distinct statuses for different team workflows.

**Assigning Collections to Teams**

Once your statuses and collections are set up, the next step is to assign these collections to specific teams. This is done under "Assign Collections." By doing so, you can ensure that each team's Kanban board is customized to their unique workflow and preferences. This level of customization enhances the efficiency and effectiveness of the Kanban board, making it an invaluable tool for project management and team collaboration.
