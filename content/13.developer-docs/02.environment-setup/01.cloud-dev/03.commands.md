...
- Deploys EC2 instance with auto-stop scheduler
...
Tail logs from the backend. If the backend is running in a tmux session, this attaches to it. Otherwise, it tails backend log files.
