...
- Auto-kills any stale process on port 3001 before starting (prevents `EADDRINUSE` errors)
...
4. Checks for pending DB migrations and runs them automatically
...
- When secrets appear to be missing or stale
