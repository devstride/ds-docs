...
```bash
ds utils repair item-aggregations --target phil-main -o org_abc123
```
...
```bash
ds utils repair item-hierarchy --target phil-main -o org_abc123
```
...
```bash
ds utils repair min-max-dates --target phil-main
```
...
ds utils delete-orphaned-items --target phil-main --dry-run

# Execute deletion
ds utils delete-orphaned-items --target phil-main
```
