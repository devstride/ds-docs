...
::alert{type="tip" title="Two faster ways to add many items"}
To turn existing notes or documents into a batch of items at once, see [Creating Items with AI](/workstreams-and-work-items/ai-item-creation). To navigate, bulk-edit, and quick-add work across your whole hierarchy, see [Using the Map](/workstreams-and-work-items/using-the-map).
::
