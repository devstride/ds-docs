...
::alert{type="warning" title="Saving templates is Admin-only"}
Only organization Admins can **Save**, **Update Template**, or **Delete** reusable templates. Anyone who can add items can still **select and apply** both pre-built and previously saved organization templates, and can type one-off custom instructions — they simply can't persist new ones.
::
