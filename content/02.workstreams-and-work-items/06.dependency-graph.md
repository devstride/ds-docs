...
You open the graph from an item's Relationships dialog:

1. Open the item you want to inspect.
2. Open its **Relationships** dialog.
3. In the **Summary** section at the top, click the purple **View Graph** button in the top-right corner.
