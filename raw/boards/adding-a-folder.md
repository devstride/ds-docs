...
![Boards section showing the New Folder button in the interface](/images/new-folder-button.png)
...
![Create folder dialog showing all configuration options including cadence and status collection](/images/create-folder-dialog.png)
