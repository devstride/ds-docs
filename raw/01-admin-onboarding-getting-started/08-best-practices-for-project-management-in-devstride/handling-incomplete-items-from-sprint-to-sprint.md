...
1. Enter your actual time committed within this sprint in Story 1.
2. Duplicate the Story using the duplicate item button or edit menu to create a cloned Story 2.
3. (Optionally) Tag Story 1 as “Incomplete” or whatever word works for you.
4. (Optimally) go to relationships and make story 1 either “related to” or “A dependency of” Story 2 for your use case.
5. Mark Story 1 as “Done”. This now easily pulls on reports as Done -> incomplete and you can start looking for patterns here.
6. Estimate the remaining work in Story 2.
7. Continue working in Story 2 and track the remaining time and activity there.
