# Pulling it all together: Planned Value to Delivery
...
Structure these hierarchically using DevStride’s[ item types](/v1/docs/setting-up-your-item-type-hierarchy).
...
<alert title="Avoid Structuring Workstreams by Team" type="warning">
<br />


Don’t create workstreams like “Frontend Team” or “QA Team.”Instead, capture what the teams are building, not who is building it.
...
1. Navigate to items in your porfolio under Map Value (e.g., “Feature: Customer Login”).
