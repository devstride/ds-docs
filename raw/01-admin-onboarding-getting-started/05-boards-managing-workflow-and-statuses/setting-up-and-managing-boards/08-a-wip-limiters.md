...
<alert title="How to WIP your Work Queue into Shape" type="info">
...
Each additional work item - even if small - causes additional collateral effort in several different ways, just like big items do. You have to include both small items and big items in assignments, meetings, reviews, etc. Cognitive attention increases across the load of all the things you are managing and time necessarily increases against every item in that queue - increasing the overall time.
